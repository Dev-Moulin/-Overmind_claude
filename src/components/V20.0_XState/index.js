// 🚀 Point d'entrée V20.0 - XSTATE STORE MIGRATION ARCHITECTURE
import V20Scene from './V20Scene.jsx';

// Export par défaut pour App.jsx (nouvelle V20.0)
export default V20Scene;

// === COMPOSANTS PRINCIPAUX ===
export { default as V20Scene } from './V20Scene.jsx';
export { default as V3Scene } from './components/V3Scene.jsx';
export { default as Canvas3D } from './components/Canvas3D.jsx';

// === XSTATE V20.0 - Debug Panel Unique ===
export { default as XStateDebugPanel } from './components/XStateDebugPanel.jsx';

// === XSTATE V20.0 HOOKS ===
export { useSceneMachine } from './stores/xstate/hooks/useSceneMachine.js';

// === DEBUGPANEL - Phase 2 Migration (Legacy) ===
export { default as DebugPanel } from './components/DebugPanel.jsx'; // Legacy (Phase 1)
export { default as DebugPanelV2 } from './components/DebugPanelV2.jsx'; // Phase 2 - 100% Zustand
export { default as TestPhase2Integration } from './components/TestPhase2Integration.jsx'; // Phase 2 Test

// === ZUSTAND STORE & HOOKS - Phase 2 (Legacy) ===
